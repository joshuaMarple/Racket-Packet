...
(define (sinner q)
  (if (complex? q)
      (sin q)
      (if (quaternion? q) 
          (if (= (qmag (list (quaternion-b q) (quaternion-c q) (quaternion-d q))) 0) (sin (quaternion-a q))
...
(define (coser q)
  (if (complex? q)
      (cos q)
      (if (quaternion? q)
          (if (= (qmag (list (quaternion-b q) (quaternion-c q) (quaternion-d q))) 0) (cos (quaternion-a q))
...
(define (logger q)
  (if (complex? q)
      (log q)
      (if (quaternion? q)
          (if (= (qmag (list (quaternion-b q) (quaternion-c q) (quaternion-d q))) 0) (log (quaternion-a q))
...
(define (eer q)
  (if (complex? q)
      (exp q)
      (if (quaternion? q)
          (if (= (qmag (list (quaternion-b q) (quaternion-c q) (quaternion-d q))) 0) (exp (quaternion-a q))
              (qexp (list (quaternion-a q) (quaternion-b q) (quaternion-c q) (quaternion-d q))))
          "error")))
