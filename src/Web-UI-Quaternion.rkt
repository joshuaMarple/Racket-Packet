            ...
            `(html(head(title "Quaternion Calculator"))
                  ...
                  (center
                   (body ((style "background-color: #08088A; font-family: frosty; font-size: 12pt; color: WHITE; width: 100%; height: 90%"))
                     ...
                     (a ((href "https://docs.google.com/file/d/0Bxyic9CAAei_ZkhjaUFlb2FXOFE/edit") (style "color: #C0C0C0")) "User Manual")(br)
                     (a ((href "https://docs.google.com/file/d/0Bxyic9CAAei_QTVabkZIdzhMbTg/edit") (style "color: #C0C0C0")) "System Documentation")
                   (br)(br)(br)(br)(br)
